package com.app.cineyatv.databases.prefs;

import static com.app.cineyatv.Config.CATEGORY_VIEW_TYPE;
import static com.app.cineyatv.Config.CHANNEL_VIEW_TYPE;
import static com.app.cineyatv.Config.DEFAULT_PLAYER_SCREEN_ORIENTATION;
...
public class SharedPref {
    ...
    public String getBaseUrl() {
        return sharedPreferences.getString("api_url", "http://ANDDAILYFRESH.COM");
    }

    public String getApplicationId() {
        return sharedPreferences.getString("application_id", "com.app.cineyatv");
    }
    ...
    public String getMoreAppsUrl() {
        return sharedPreferences.getString("more_apps_url", "https://play.google.com/store/apps/developer?id=yacinelivetv");
    }
